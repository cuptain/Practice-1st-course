...
/// Задача №12 (сортировка простыми вставками и сортировка с помощью двоичного дерева).
/// Сравнивает два типа сортировки одномерных массивов разной упордяоченности
/// с подсчётом сравнений и количества пересылок
/// 
